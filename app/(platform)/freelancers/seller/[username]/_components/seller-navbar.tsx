        ...
        <div className="relative">
            <div className="flex justify-center lg:absolute top-0 right-0">
                <div className="w-fit flex gap-x-1 items-center p-3">
                    ...
                    {currentUser && (
                        <Button variant={"ghost"} className="text-muted-foreground" onClick={() => router.push(`/freelancers`)}>
                            Switch To Buying
                        </Button>
                    )}
                    <UserButton />
            ...
            <div className="flex w-full justify-center p-3">
                <NavigationMenu>
                    <NavigationMenuList className="flex flex-col md:flex-row">
                        <NavigationMenuItem>
                            <Link href={`/freelancers/seller/${currentUser?.username}/manage-gigs`} legacyBehavior passHref>
                        ...
                        {/* <NavigationMenuItem>
                            ...
                            <NavigationMenuContent>
                                <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                                    ...
                                    <ListItem href={`/freelancers/seller/${currentUser?.username}/manage-gigs`} title="Gigs">
                                        Manage, create and edit your gigs here.
                                    </ListItem>
                                    <ListItem href={`/freelancers/seller/${currentUser?.username}/profile`} title="Profile">
