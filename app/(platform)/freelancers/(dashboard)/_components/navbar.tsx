            ...
            <div className="flex items-center gap-x-4 p-5 bg-white">
                ...
                {currentUser && (
                    <>
                        ...
                        <Button onClick={() => router.push(`/collabration/organization`)}>
                            Back To Collabration
                        </Button>
                        <Button onClick={() => router.push(`/freelancers/seller/${currentUser.username}/manage-gigs`)}>
                            Switch To Selling
                        </Button>
